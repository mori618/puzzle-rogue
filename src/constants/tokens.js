const ALL_TOKEN_BASES = [
  ...
  // --- スキル: リピートドロップ生成 ---
  { id: "gen_repeat_rand", name: "循環の理", type: "skill", cost: 3, costLevels: true, action: "spawn_repeat", params: { count: 1 }, rarity: 1, price: 5, desc: "ランダムなドロップ1つをリピートドロップ（2回消える）にする。消費E:{cost}" },
  ...
  // --- スキル: スタードロップ生成 ---
  { id: "gen_star_rand", name: "星の創造", type: "skill", cost: 3, costLevels: true, action: "spawn_star", params: { count: 5 }, rarity: 1, price: 6, desc: "ランダムなドロップ5つをスタードロップにする。消費E:{cost}" },
  ...
  // --- スキル: 虹ドロップ生成 ---
  { id: "gen_rainbow_rand", name: "虹の創造", type: "skill", cost: 2, costLevels: true, action: "spawn_rainbow", params: { count: 1 }, rarity: 1, price: 6, desc: "ランダムなドロップ1つをカウント3の虹ドロップにする。消費E:{cost}" },
  ...
  // ==========================================
  {
    ...
    price: 0,
    isLocked: true,
    desc: "1サイクルの手番が1減る。条件:5サイクル分クリアする。",
    condition: "clears",
    targetValue: 5,
  },
  {
    ...
    price: 0,
    isLocked: true,
    desc: "ハートドロップを消してもコンボが増えなくなる。条件:ハートドロップを30個消す。",
  ...
  },
  {
    ...
    price: 0,
    isLocked: true,
    desc: "操作時間が4秒固定になる。条件:累計50コンボする。",
  ...
  },
  {
    ...
    price: 0,
    isLocked: true,
    desc: "常時落ちコンが発生しなくなる。条件達成まで売却不可。:累計50スター獲得する。",
  ...
  },
  {
    ...
    price: 0,
    isLocked: true,
    desc: "コンボ数が半分になる（倍率0.5）。条件:1手番で30コンボ達成する。",
    condition: "max_combo",
    targetValue: 30,
  },
  {
    ...
    price: 0,
    isLocked: true,
    desc: "初期スターが0になり、スター獲得に必要なコンボ数が1増える。条件:トークンを累計5つ売却する。",
