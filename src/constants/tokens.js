const ALL_TOKEN_BASES = [
  ...
  // --- 新規追加: L字消し関連トークン ---
  {
    id: "l_shape_double_base_mult",
    name: "L字の共鳴",
    icon: "grid_goldenratio",
    type: "passive",
    effect: "shape_double_l_mult",
    values: [1.5, 2.0, 3.0],
    rarity: 2,
    price: 18,
    desc: "L字消しを2個同時にすると、基礎コンボ数を[1.5/2/3]倍する。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "l_shape_count_star",
    name: "L字の財宝",
    icon: "monetization_on",
    type: "passive",
    effect: "l_shape_count",
    isCountPassive: true,
    values: [10, 7, 5],
    effectValues: [30, 50, 100],
    rarity: 2,
    price: 16,
    desc: "L字消しを累計[10/7/5]回成功させるごとに、[30/50/100]スターを獲得する。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "l_shape_spawn_repeat",
    name: "L字の輪廻",
    icon: "autorenew",
    type: "passive",
    effect: "l_shape_repeat",
    values: [1, 2, 3],
    rarity: 2,
    price: 15,
    desc: "L字消しした際、盤面のランダムなドロップ[1/2/3]個をリピートドロップにする。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "l_shape_skill_max",
    name: "L字の脈動",
    icon: "bolt",
    type: "passive",
    effect: "l_shape_skill_max",
    values: [0.05, 0.10, 0.20],
    rarity: 3,
    price: 28,
    desc: "L字消しした際、[5/10/20]%の確率でランダムなアクティブスキルのエネルギーがMAXになる。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "l_cross_simultaneous_mult",
    name: "交差する秘技",
    icon: "join_inner",
    type: "passive",
    effect: "l_cross_mult",
    ...
    rarity: 3,
    price: 30,
    desc: "L字消しと十字消しを同時にすると、基礎コンボ数を[3/4/5]倍する。",
    attributes: [],
    canBeInitial: true
  },
  // --- 新規追加: 十字消し関連トークン ---
  {
    id: "cross_double_base_mult",
    name: "十字の結界",
    icon: "add_box",
    type: "passive",
    effect: "shape_double_cross_mult",
    values: [2.0, 3.0, 4.0],
    rarity: 2,
    price: 20,
    desc: "十字消しを2個同時にすると、基礎コンボ数を[2/3/4]倍する。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "cross_count_token",
    name: "十字の福音",
    icon: "card_giftcard",
    type: "passive",
    effect: "cross_count",
    ...
    rarity: 3,
    price: 32,
    desc: "十字消しを累計[12/10/8]回成功させるごとに、ランダムな星3トークンを生成する。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "cross_multiply_move_drop",
    name: "十字の加速",
    icon: "speed",
    type: "passive",
    effect: "cross_multiply_move_drop",
    values: [1.5, 2.0, 3.0],
    rarity: 2,
    price: 18,
    desc: "十字消しした際、盤面のムーブドロップのカウントを[1.5/2/3]倍する。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "cross_enchant_self",
    name: "十字の加護",
    icon: "auto_awesome",
    type: "passive",
    effect: "cross_enchant_self",
    values: [0.10, 0.20, 0.30],
    rarity: 2,
    price: 22,
    desc: "十字消しした際、[10/20/30]%の確率でランダムなエンチャントがこのトークンに付与される。",
    attributes: [],
    canBeInitial: true
  },
  // --- 新規追加: 正方形消し関連トークン ---
  {
    id: "square_count_combo_mult",
    name: "方陣の残響",
    icon: "layers",
    type: "passive",
    effect: "square_count",
    isCountPassive: true,
    values: [3, 3, 3],
    effectValues: [1.5, 2.0, 3.0],
    rarity: 2,
    price: 18,
    desc: "正方形消しを累計3回成功させるごとに、ターン終了後に獲得コンボ数を[1.5/2/3]倍する。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "square_convert_left_bottom",
    name: "左下の伝承",
    icon: "grid_view",
    type: "passive",
    effect: "square_convert_left_bottom",
    values: [0.20, 0.40, 0.60],
    rarity: 2,
    price: 20,
    desc: "正方形消しした際、[20/40/60]%の確率でターン終了後に、盤面左下の9個のドロップをこのトークンの属性（左隣のトークンの属性）のドロップに変換する。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "square_spawn_repeat",
    name: "方陣の輪廻",
    icon: "history",
    type: "passive",
    effect: "square_repeat",
    values: [2, 3, 5],
    rarity: 2,
    price: 16,
    desc: "正方形消しした際、盤面のランダムなドロップ[2/3/5]個をリピートドロップにする。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "square_combo_addition",
    name: "方陣の極み",
    icon: "star_outline",
    type: "passive",
    effect: "square_combo_add",
    values: [10, 15, 30],
    rarity: 2,
    price: 22,
    desc: "正方形消しでコンボ+[10/15/30]。",
    attributes: [],
    canBeInitial: true
  },
  // --- 新規追加: 横1列消し関連トークン ---
  {
    id: "row_count_convert_top",
    name: "上部の伝承",
    icon: "vertical_align_top",
    type: "passive",
    effect: "row_count",
    ...
    rarity: 2,
    price: 18,
    desc: "横1列消しを累計[12/10/8]回成功させるごとに、ターン終了後に盤面最上部1列をこのトークンの属性（左隣のトークンの属性）のドロップに変換する。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "row_triple_base_mult",
    name: "横列の共鳴",
    icon: "reorder",
    type: "passive",
    effect: "shape_triple_row_mult",
    values: [2.0, 3.0, 4.0],
    rarity: 3,
    price: 24,
    desc: "横1列消しを3個同時にすると、基礎コンボ数を[2/3/4]倍する。",
    attributes: [],
    canBeInitial: true
  },
  {
    ...
    rarity: 2,
    price: 16,
    desc: "横1列消しした際、盤面のランダムなドロップ[2/3/5]個をプラススタードロップにする。",
    attributes: [],
    canBeInitial: true
  },
  {
    ...
    icon: "local_play",
    type: "passive",
    effect: "row_free_reroll",
    values: [0.10, 0.20, 0.30],
    rarity: 2,
    price: 20,
    desc: "横1列消しした際、[10/20/30]%の確率でショップのリロール価格が1回無料になる（未使用分は蓄積）。",
    attributes: [],
    canBeInitial: true
  },
  // --- 新規追加: 4つ消し・5つ消し関連トークン ---
  {
    id: "len4_quad_base_mult",
    name: "4連の共鳴",
    icon: "filter_4",
    type: "passive",
    effect: "shape_quad_len4_mult",
    values: [2.0, 3.0, 4.0],
    rarity: 2,
    price: 24,
    desc: "4個消しを4個同時にすると、基礎コンボ数を[2/3/4]倍する。",
    attributes: [],
    canBeInitial: true
  },
  {
    ...
    rarity: 1,
    price: 16,
    desc: "4個消しした際、盤面のランダムなドロップ[1/2/3]個をプラスドロップにする。",
    attributes: [],
    canBeInitial: true
  },
  {
    ...
    rarity: 2,
    price: 22,
    desc: "4個消しした際、[10/20/30]%の確率でランダムなトークンを生成する。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "len4_count_all_plus",
    name: "4連の奇跡",
    ...
    rarity: 2,
    price: 22,
    desc: "4個消しを累計[15/10/7]回するごとに、効果が発動する。ターン終了後に、盤面のドロップ全てをプラスドロップにする。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "len5_random_enchant",
    name: "5連の加護",
    icon: "auto_fix_high",
    type: "passive",
    effect: "len5_enchant",
    ...
    rarity: 2,
    price: 24,
    desc: "5個以上連結消しした際、[10/20/30]%の確率でランダムにエンチャントを付与する（どのトークンにつくかも何がつくかもランダム）。",
    attributes: [],
    canBeInitial: true
  },
  {
    id: "len5_count_level_up",
    name: "5連 of 成長",
    icon: "upgrade",
    type: "passive",
    effect: "len5_count",
    ...
    rarity: 3,
    price: 26,
    desc: "5個以上連結消しを累計[10/8/1]回するごとに、効果が発動する。ランダムなトークンをレベルアップさせる。（現在: {charge}回）",
    attributes: [],
    canBeInitial: true
  },
  {
    ...
    rarity: 3,
    price: 36,
    desc: "「エンチャントが3つ以上付与されているトークン」 1つにつき、基礎コンボ数が[1.5/2.0/3.0]倍になる。",
    attributes: []
  },
  {
    id: "sublimation_rune",
    ...
    rarity: 3,
    price: 32,
    desc: "このトークンにエンチャントが3つ以上付与された時、それらをすべて消費（消去）し、コンボ倍率を永続的に+[1.0/1.5/2.0]する（現在のボーナス: +{sublimationBonus}）。",
    attributes: []
  },
  {
    id: "contagious_enchant",
    name: "伝染 of 刻印",
    icon: "control_point_duplicate",
    type: "passive",
    effect: "contagious_enchant",
    values: [20, 40, 60],
    rarity: 3,
    price: 30,
    desc: "ターン終了時、このトークンに付与されているランダムなエンチャント（自身を除く）のコピーを、隣接する別のトークンに付与する（確率[20/40/60]%）。",
    attributes: []
  }
];
